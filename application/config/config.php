...
$config['sess_cookie_name'] = 'maxwell_session';
...
DESC   : CUSTOM CONFIG
*/
$config['financial_year_start_YMD'] = date('Y-04-01');
$config['financial_year_end_YMD'] = date('Y-03-31');
$config['financial_year_starting_month'] = '04';
$config['financial_year_ending_month'] = '03';
