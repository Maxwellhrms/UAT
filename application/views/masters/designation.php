            ...
            <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
								<h3 class="page-title">Create Your Designation Master</h3>
								<ul class="breadcrumb">
...
<button type="button" class="btn btn-primary" data-toggle="collapse" data-target="#demo">Register New Designation</button>
						...
						<div class="col-md-12">
							<div class="card mb-0">
								<div class="card-header">
									<h4 class="card-title mb-0">Designation Details</h4>
								</div>
								<div class="card-body">
												...
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control select select2" name="gradename" id="gradename">
															...
															<option value="<?php echo $grvalue->mxgrd_id .'~'. $grvalue->mxgrd_name ?>"><?php echo $grvalue->mxgrd_name ?></option>
															<?php } ?>
														</select>
								...
								<div class="card-body">	
									...
									<div class="table-responsive">
                                        <table class="datatable table table-stripped mb-0" id="dataTables-example">
											...
											<tbody>
												<?php foreach ($designationdetails as $key => $descvalue) { ?>
												<tr>
													<td><?php echo $descvalue->mxcp_name ?></td>
													<td><?php echo $descvalue->mxgrd_name ?></td>
													<td><?php echo $descvalue->mxdesg_name ?></td>
													<td>
													<div class="dropdown dropdown-action">
													<a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="material-icons">more_vert</i></a>
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <?php if($this->session->userdata('user_role_edit') == 1){ ?><a class="dropdown-item" href="<?php echo base_url() ?>admin/editdesignation/<?php echo $descvalue->mxdesg_id ?>"><i class="fa fa-pencil m-r-5"></i> Edit</a><?php } ?>
                                                    <?php if($this->session->userdata('user_role_delete') == 1){ ?><a class="dropdown-item deletemodal" data-toggle="modal" data-target="#delete" data-id="<?php echo $descvalue->mxdesg_id .'~'. $descvalue->mxdesg_name; ?>"><i class="fa fa-trash-o m-r-5"></i> Delete</a><?php } ?>
                                                </div>
												</div>
													</td>
												</tr>
