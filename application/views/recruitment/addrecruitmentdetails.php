		...
		<div class="col-xl-12">
			<div class="row">
				...
				<div class="col-md-3">
					...
					<?php if(isset($resume) && !empty($resume)){ echo "<a class='link attach-icon' target='_blank' href='$resume'><img src='https://maxwellhrms.in/assets/img/attachment.png'></a>";} ?>	    
					</div>
					</div>
				...
				<div class="col-md-3">
					...
					<input type="text" class="form-control" name="candidatecurrentlocation" id="candidatecurrentlocation" autocomplete="off">
				...
				<div class="col-md-2">
					...
					<input type="text" class="form-control" name="totalexperience" id="totalexperience" autocomplete="off">
				...
				<div class="col-md-2">
					...
					<select class="form-control" name="recruitmenttype" id="recruitmenttype" autocomplete="off">
                        <?php echo $controller->display_options('ats_recruitmenttype',''); ?>
					</select>
			...
			<div class="row">
				...
				<div class="col-md-2" style="display:none" id="nau_link_open">
					<div class="form-group">
						...
						<select class="form-control" name="refrencename_website" id="refrencename_website" autocomplete="off">
						    <?php echo $controller->display_options('ats_refrencename_customwebsites',''); ?>
						</select>
					</div>
				</div>
				...
				<div class="col-md-2" style="display:none" id="arc_open">
					<div class="form-group">
						...
						<input type="text" class="form-control" name="refrencebranch" id="refrencebranch" autocomplete="off">
					</div>
				</div>
				<div class="col-md-2" style="display:none" id="website_open">
					<div class="form-group">
						...
						<select class="form-control" name="refrencewebsite_type" id="refrencewebsite_type" autocomplete="off">
						    <?php echo $controller->display_options('ats_refrencewebsite_type',''); ?>
						</select>
					</div>
				</div>
				<div class="col-md-3">
			...
			<div class="row">
				...
				<div class="col-md-1">
					<div class="form-group">
                        ...
                        <input type="hidden" name="resume_site" id="resume_site" value="<?php echo $resume; ?>">
