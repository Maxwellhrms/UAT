        ...
        <?php /*    <div class="page-wrapper">
                <div class="content container-fluid">
					...
					<div class="page-header">
						<div class="row">
							<div class="col-sm-12">
								<h3 class="page-title"> Attendance Register For Month </h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a href="<?php echo base_url() ?>admin/dashboard">Dashboard</a></li>
									<li class="breadcrumb-item active"> Attendance Register For Month </li>
								</ul>
							</div>
						</div>
					</div>
...
e.preventDefault();  
    ...
    var mainurl = baseurl+'export/attendancesumarryofmonth';
