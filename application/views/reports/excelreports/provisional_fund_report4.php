...
// alert('<?php //echo $excelheading; ?>');
    ...
    $(".hidingthecol2").css("display", "block");
$("form#commonform").submit(function(e) {
        ...
        try{
            ...
            var mainurl = baseurl+'export/pf_report_list4';
            show_loader()
            ...
            $.ajax({
                ...
                type: "post",
                async: false,
                data: {'month_year': month_year,'companyid': company_id, 'divisonid': div_id,'stateid':state_id,'branchid':branch_id,'employeeid':empid,'filter':'1','day':day,'is_finanical':is_finanical,'is_finanical_all':is_finanical_all},
