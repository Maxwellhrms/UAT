...
$("form#commonform").submit(function(e) {
        ...
        var mainurl = baseurl+'export/attendance_latecomming_report_list';
        $.ajax({
            url: mainurl,
            type: "post",
            async: false,
            data: {'month_year': month_year,'companyid': company_id, 'divisonid': div_id,'stateid':state_id,'branchid':branch_id,'employeeid':empid,'filter':'1','day':day },
