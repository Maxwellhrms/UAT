<?php echo $controller1->mastersfilters_paystructure($ym='Y',$cmp='Y',$div='Y',$stateid='Y',$branch='Y',$emplid='N',$grade='N',$empjoin='N',$categ='N',$day='N',$from ='N',$to ='N',$emp_type='N',$is_quaterly='N'); ?>
<!--  7 variables -->
...
$("form#commonform").submit(function(e) {
        ...
        try{
            ...
            var mainurl = baseurl+'export/esi_return_report_list2';
            show_loader()
