...
$("form#commonform").submit(function(e) {
        ...
        try{
            ...
            var half_month_year = $("#half_month_year").val();
            ...
            }else if(half_month_year){
                var mnth = $("#half_month_year").val();
                if (mnth == 0 || mnth == "") {
                    $("#half_month_year").focus();
                    $('#half_month_year').html("Please Select FinancialYear");
                    return false;
                } else {
                    $('#attndmontherror').html("");
                }
            ...
            var mainurl = baseurl+'export/emp_wise_pt_report_list_m';
            show_loader()
