...
$("form#commonform").submit(function(e) {
        ...
        var mainurl = baseurl+'export/employee_attendance_punch_details_list';

        $.ajax({
            url: mainurl,
            type: "post",
            async: false,
            data: {'month_year': month_year,'companyid': company_id, 'divisionid': div_id,'stateid':state_id,'branchid':branch_id,'employeeid':empid,'filter':'1','attendancedate':day},
