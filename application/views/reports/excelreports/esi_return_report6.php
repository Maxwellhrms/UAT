<?php echo $controller1->mastersfilters_paystructure($ym='N',$cmp='Y',$div='Y',$stateid='Y',$branch='Y',$emplid='N',$grade='N',$empjoin='N',$categ='N',$day='N',$from ='N',$to ='N',$emp_type='N',$is_quaterly='N'); ?>
<!--  7 variables -->
...
// alert('<?php //echo $excelheading; ?>');
	 ...
	 $(".half_month_year_div").css("display", "block");
$("form#commonform").submit(function(e) {
        ...
        try{
            ...
            var mainurl = baseurl+'export/esi_return_report_list_6';
            show_loader()
