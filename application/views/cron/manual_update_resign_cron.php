...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Manual Resign Status Update Cron</h3>
                    <ul class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="card mb-0">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Run Resign Status Update Cron</h4>
                    </div>
                    <div class="card-body">
                        <form id="run_resign_status_update_cron_form">
                            <div class="row">
                                <div class="col-xl-6">
...
<script src="<?php echo base_url() ?>assets/js/formsjs/manual_update_resign_status_cron.js"></script>