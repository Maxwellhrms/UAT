...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Increments Cron</h3>
                    <ul class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="card mb-0">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Increments Cron</h4>
                    </div>
                    <div class="card-body">
                        <form id="increment_cron_form">
                            <div class="row">
                                <div class="col-xl-6">
...
<script src="<?php echo base_url() ?>assets/js/formsjs/increment_cron.js"></script>