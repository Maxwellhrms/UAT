...
<div class="page-wrapper">
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col">
                    <h3 class="page-title">Manual Public Holiday Absent Cron</h3>
                    <ul class="breadcrumb">
            ...
            <div class="col-md-12">
                <div class="card mb-0">
                    <div class="card-header">
                        <h4 class="card-title mb-0">Run Public Holiday Absent Cron</h4>
                    </div>
                    <div class="card-body">
                        <form id="run_public_holiday_absent_from">
                            <div class="row">
                                <div class="col-xl-6">
...
<script src="<?php echo base_url() ?>assets/js/formsjs/manual_public_holiday_absent.js"></script>