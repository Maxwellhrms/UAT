                        ...
                        <table class="datatable table table-stripped mb-0" id="dataTables-example">
							<thead>
								<tr>
									...
									<th>Name</th>
									<th>Mobile Role</th>
									<th>Mobile Login Permission Status</th>
									<th>Mobile Type</th>
									<th>Mobile No</th>
									<th>Email</th>
									<th>Device ID</th>
							...
							<tbody>
								...
								<tr>
									...
									<td><?php
									if(array_key_exists($value->mxemp_emp_lg_app_role, $roles)){
										echo $roles[$value->mxemp_emp_lg_app_role];
									}
									  ?></td>
									<td>
									<?php if(array_key_exists($value->mxemp_emp_lg_app_permissions, $status)){
										echo $status[$value->mxemp_emp_lg_app_permissions];
									}?>	
									</td>
									<td><?php if(array_key_exists($value->mxemp_emp_lg_mobile_type, $utility)){ echo $utility[$value->mxemp_emp_lg_mobile_type]; } ?></td>
									<td><?php echo $value->mxemp_emp_lg_mobile_no; ?></td>
									<td><?php echo $value->mxemp_emp_lg_email; ?></td>
									<td><?php echo $value->mxemp_emp_lg_device_id; ?></td>
								</tr>
								<?php $sno++; } ?>
							</tbody>
						</table>
