...
<script type="text/javascript">
  $("#roles").change(function () {
    ...
    var roles = $("#roles").val();
    $.ajax({
      url: baseurl + 'Permissions/getallmenus',
      type: 'POST',
      data: { roleid: roles },
...
$("form#processrolesdata").submit(function (e) {
  ...
  mainurl = baseurl + 'Permissions/saverolespermissions';
...
<div class="col-sm-12 col-md-12">  
	...
	<div class="col-lg-9">
		<div class="form-check form-check-inline">
			<input class="form-check-input" type="checkbox" id="create_new" name="create_new" value="1" >
			<label class="form-check-label">
				Create
			</label>
		</div>
		<div class="form-check form-check-inline">
			<input class="form-check-input" type="checkbox" id="update_new" name="update_new" value="1" >
			<label class="form-check-label">
				Update 
			</label>
		</div>
		<div class="form-check form-check-inline">
			<input class="form-check-input" type="checkbox" id="delete_new" name="delete_new" value="1" >
			<label class="form-check-label">
				Delete 
			</label>
		</div>
				...
				<tbody>
					...
					<tr>
						...
						<td class="text-center">
							<div class="col-lg-9">
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" id="create_<?php echo $val->maxuser_roles_id ?>" name="create_<?php echo $val->maxuser_roles_id ?>" value="1" <?php if($val->maxuser_roles_add == 1){ echo 'checked';}else{ echo '';} ?> onclick="create('<?php echo $val->maxuser_roles_id ?>')" >
									<label class="form-check-label">
										Create
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" id="update_<?php echo $val->maxuser_roles_id ?>" name="update_<?php echo $val->maxuser_roles_id ?>" value="1" <?php if($val->maxuser_roles_edit == 1){ echo 'checked';}else{ echo '';} ?> onclick="edit('<?php echo $val->maxuser_roles_id ?>')" >
									<label class="form-check-label">
										Update 
									</label>
								</div>
								<div class="form-check form-check-inline">
									<input class="form-check-input" type="checkbox" id="delete_<?php echo $val->maxuser_roles_id ?>" name="delete_<?php echo $val->maxuser_roles_id ?>" value="1" <?php if($val->maxuser_roles_delete == 1){ echo 'checked';}else{ echo '';} ?> onclick="deleter('<?php echo $val->maxuser_roles_id ?>')" >
									<label class="form-check-label">
										Delete 
									</label>
								</div>
...
<script>
  $('#processaddnewroles').click(function (e) {
    ...
    $.ajax({
      url: baseurl + 'Permissions/addnewroles',
      type: 'POST',
  ...
  function create(id){
    ...
    if($('input[name='+createname+']').is(':checked')){
		...
		var mainurl = "Permissions/updatecreatecheck";
  ...
  function edit(id){
    ...
    if($('input[name='+updatename+']').is(':checked')){
		...
		var mainurl = "Permissions/updateeditcheck";
  ...
  function deleter(id){
    ...
    if($('input[name='+deletename+']').is(':checked')){
		...
		var mainurl = "Permissions/updatedeletecheck";
