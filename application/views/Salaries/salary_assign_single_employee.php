...
<div class="page-wrapper">
    ...
    <div class="content container-fluid">
        ...
        <div class="page-header">
            <div class="row">
                <div class="col-sm-12">
                    <h3 class="page-title">Assign Employee Salary</h3>
                    <ul class="breadcrumb">
                        <li class="breadcrumb-item"><a href="index.html">Salary Generate</a></li>
                        <li class="breadcrumb-item active">Assign Salary To Emp</li>
                    </ul>
                </div>
            </div>
        </div>
                                                                ...
                                                                <div class="card-body">                                        
                                                                    <div class="row">
                                                                            ...
                                                                            <div class="form-group col-md-4">
                                                                                ...
                                                                                <div class="col-lg-12">
                                                                                    <button type="button" id="delete_sal" class="btn btn-primary">Generate Sal</button>
                                                                                </div>
                                                                            </div>
                                                                    </div>
                                                                </div>
