...
e.preventDefault();  
        ...
        // alert(month_year);
        var mainurl = baseurl+'mobileapidisplay/finalleavelist';
        $.ajax({
            url: mainurl,
            type: "post",
            async: false,
            data: {'month_year': month_year,'companyid': company_id, 'divisonid': div_id,'stateid':state_id,'branchid':branch_id,'employeeid':empid,'filter':'1','finalhraccept':'1','approvstatus':approvstatus},
