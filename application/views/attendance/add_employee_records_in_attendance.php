				    ...
				    <div class="content container-fluid">
				        ...
				        <div class="page-header">
				            <div class="row align-items-center">
				                <div class="col">
				                    <h3 class="page-title">Add Employee Records In Attendance</h3>
				                    <ul class="breadcrumb">
				                        <li class="breadcrumb-item"><a href="<?php echo base_url() ?>admin/dashboard">Dashboard</a></li>
				                        <li class="breadcrumb-item active">Add Employee Records In Attendance</li>
				                    </ul>
				                </div>
				            </div>
				        </div>
				        ...
				        <!-- Search Filter -->
				        <form id="add_employee_attendance_form">
				            <div class="row filter-row">	                				                
				                ...
				                <div class="col-sm-6 col-md-3">
				                    <button type="submit" class="btn btn-success btn-block"> Add Employee Records </button>
				                </div>
				            </div>
				        </form>
				        <!-- Search Filter -->
				...
				<!-- /Page Wrapper -->
                    ...
                    <script src="<?php echo base_url() ?>assets/js/formsjs/add_employee_records_in_attendance.js"></script>