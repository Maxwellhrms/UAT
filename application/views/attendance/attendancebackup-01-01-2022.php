...
function filterattnd(){
	...
	var mainurl = baseurl+'admin/getemployeeattendancehistory';
$.ajax({
    url: mainurl,
    type: 'POST',
...
var mainurl = baseurl+'admin/getdetailedpunchreport';
$.ajax({
    url: mainurl,
    type: 'POST',
    data: {attedancedate : date, employeecode : employeecode},
    success: function (data) {
    	$(".modal-body .display_punches").html(data);
    },
});
					...
					<div class="modal-dialog modal-dialog-centered modal-lg" role="document">
								...
								<div class="row">
									<div class="col-md-12">
										<div class="card punch-status">
											<div class="card-body">
												<h5 class="card-title">Manual Modify <small class="text-muted" id="dateofattendance"></small></h5>
												<div class="row filter-row">
						<div class="col-sm-6 col-md-3">  
							<!-- <div class="form-group form-focus"> -->
								<label class="focus-label">Attendance Date</label>
								<input type="text" class="form-control floating" name="editempdate" id="editempdate" readonly="">
							<!-- </div> -->
						</div>
						<div class="col-sm-6 col-md-3">  
							<!-- <div class="form-group form-focus"> -->
								<label class="focus-label">Employee Code</label>
								<input type="text" class="form-control floating" name="editempid" id="editempid" readonly="">
							<!-- </div> -->
						</div>
						<!-- <div class="col-sm-6 col-md-3">   -->
							<!-- <div class="form-group form-focus"> -->
								<!-- <label class="focus-label">Employee Row Id</label> -->
								<input type="hidden" class="form-control floating" name="editempmainid" id="editempmainid" readonly="">
							<!-- </div> -->
						<!-- </div> -->
						<div class="col-sm-6 col-md-3"> 
							<!-- <div class="form-group form-focus select-focus"> -->
						...
						<div class="col-sm-6 col-md-6"> 
							<!-- <div class="form-group form-focus select-focus"> -->
								...
								<textarea class="form-control" style="width: 100%" name="reason" id="reason" rows="5" cols="5"> </textarea>
							<!-- </div> -->
						...
						<div class="text-right">
                            <button type="button" onclick="processeditattedance()" class="btn btn-primary">Update</button>
                        </div>
                        <?php } ?>
										</div>
									</div>
