                    ...
                    <thead>
                        <tr>
                           ...
                           <!-- <th width="15%">Unit Measure</th> -->
                            ...
                            <th width="15%">Expected Competency Rating</th>
                        </tr>
                    </thead>
...
$output .= '<select class="form-control target-field"
...
foreach($kc as $kckey => $kcval){
    ...
    if($monthtarget == $kckey){
        $selected = 'selected';
    }

    $output .= '<option value="'.$kckey.'" '.$selected.'>
                    '.$kcval.'
                </option>';
}
