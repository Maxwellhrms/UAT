    ...
    public function validateToken()
    {
        ...
        if($token_data['status'] === TRUE)
        {
            try
            {
                ...
                {
                    //----NEW BY SHABABU(22-12-2021) //-->If Below Code Uncomments Then Remove these code                   
                            return ['status' => TRUE, 'data' => $token_decode];
                    //----END NEW BY SHABABU(22-12-2021)


                    //--------> Commented By shababu(22-12-2021)  puprpose for To Remove expiry Time 
                    ...
                    //--------> END Commented By shababu(22-12-2021)  puprpose for To Remove expiry Time 
