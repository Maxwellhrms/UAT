...
function processForm(formId, url, redirectUrl = "") {
    ...
    .then(res => {
        ...
        // Default values
        let type = res.type || (res.statusCode == 200 ? "success" : "error");
        let message = res.message || res.errorMsg || res.errorDesc || "Something went wrong";

        // Show alert
        showAlert(type, message);

        // Redirect if success
        if (res.statusCode == 200 && baseurl+redirectUrl !== "") {
            setTimeout(() => {
