...
$("form#processzonaldetails").submit(function(e) {
e.preventDefault();  
...
if(divname ==""){
  $("#divname").focus();
  $('#divnameerror').html("Please Enter Division Name");
  return false;
...
if(zonalname ==""){
  $("#zonalname").focus();
  $('#zonalnameerror').html("Please Enter Zonal Name");
  return false;
}else{$('#zonalnameerror').html("");}


if(dp == 1){
  mainurl = baseurl+'admin/savezonaldetails';
}else if(dp == 2){
  mainurl = baseurl+'admin/saveeditzonaldetails';
}
