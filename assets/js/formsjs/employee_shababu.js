...
$(document).ready(function () {
  ...
  $("#cmpname").change(function () {
    ...
    //----------MAKING AUTHORISATIONS DEPT & EMPLOYEES LIST EMPTY
    make_all_auth_empty();
    //----------MAKING AUTHORISATIONS DEPT & EMPLOYEES LIST EMPTY
  ...
  //-------NEW BY SHABABU(17-03-2022)
  //---MAKE ALL AUTH DEPARTMENTS AND EMPLOYEES EMPTY
  function make_all_auth_empty(){
      $(".auth_dept").each(function(){
          $(this).html('');
      });
  ...
  //---END MAKE ALL AUTH DEPARTMENTS AND EMPLOYEES EMPTY
  //-------END NEW BY SHABABU(17-03-2022)
